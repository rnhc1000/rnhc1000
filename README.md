...
## Hands-on Skills
[![My Skills](https://skillicons.dev/icons?i=java,spring,mysql,postgresql,rabbitmq,mongodb,php,ts,react,docker,redhat,aws,jenkins,redis,angular,firebase)](https://skillicons.dev)
