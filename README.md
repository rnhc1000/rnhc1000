...
## Hands-on Skills
[![My Skills](https://skillicons.dev/icons?i=java,spring,mysql,postgresql,kafka,rabbitmq,redis,mongodb,php,laravel,ts,react,angular,docker,redhat,aws,jenkins,maven)](https://skillicons.dev)
